...
import { Filter, Minus, Plus, ShoppingCart, SearchX, X, ChevronLeft } from 'lucide-react';
                        ...
                        <div style={{ marginBottom: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                <button
                                    ...
                                    className="btn"
                                    style={{ background: '#f0f0f0', color: '#555', padding: '0.5rem 1rem', fontSize: '0.85rem', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '5px', borderRadius: '10px' }}
                                >
                                    <ChevronLeft size={16} /> Categorías
                                </button>
                                <h1 className="h3" style={{ margin: 0, color: 'var(--primary)', textTransform: 'uppercase', fontSize: '1.1rem' }}>
                                    {selectedCategory}
                                </h1>
                            </div>

                            {/* Horizontal Category Scroller for Easy Navigation */}
                                ...
                                <div className={styles.categoriesList}>
                                    {CATEGORIES.map((cat) => (
                                        ...
                                        >
                                            ...
                                            <div className={styles.catName} style={{ color: selectedCategory === cat ? 'var(--primary)' : 'var(--text-main)' }}>
                                                {cat.replace(' y ', ' & ')}
                                            </div>
                                        </div>
                                    ))}
